...
public final class ActivityTabBinding implements ViewBinding {
  ...
  private ActivityTabBinding(@NonNull CoordinatorLayout rootView, @NonNull FloatingActionButton fab,
  ...
  public static ActivityTabBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTabBinding((CoordinatorLayout) rootView, fab, tabs, title, viewPager);
    }
