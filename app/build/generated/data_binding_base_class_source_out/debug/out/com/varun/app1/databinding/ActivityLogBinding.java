...
public final class ActivityLogBinding implements ViewBinding {
  ...
  private ActivityLogBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView2) {
  ...
  public static ActivityLogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLogBinding((ConstraintLayout) rootView, textView2);
    }
